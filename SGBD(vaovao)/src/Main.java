...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Tester la création d'une base de données
            System.out.println("=== Création d'une base de données ===");
            ...
            System.out.println("=== Utilisation d'une base de données ===");
            ...
            // Tester des requêtes SELECT avec différentes opérations relationnelles
            ...
            // // tester sélection à partir de la vue
            ...
            // Tester la suppression de la base de données
